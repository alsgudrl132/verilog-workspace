...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L axi_lite_ipif_v3_0_4 -L mdm_riscv_v1_0_3 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_9 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot soc_dht11_iic xil_defaultlib.soc_dht11_iic xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim soc_dht11_iic -key {Behavioral:sim_1:Functional:soc_dht11_iic} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e7c.protoinst" -protoinst "protoinst_files/soc_dht11_fnd.protoinst" -protoinst "protoinst_files/soc_dht11.protoinst" -protoinst "protoinst_files/bd_67cd.protoinst" -protoinst "protoinst_files/soc_btn_fnd.protoinst" -protoinst "protoinst_files/bd_57e4.protoinst" -protoinst "protoinst_files/soc_hello.protoinst" -protoinst "protoinst_files/bd_ee87.protoinst" -protoinst "protoinst_files/soc_dht11_iic.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_dht11_iic.wdb xsim.dir libdpi.so)
