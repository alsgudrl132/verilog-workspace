...
simulate()
{
  xsim soc_dht11 -key {Behavioral:sim_1:Functional:soc_dht11} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_bddd.protoinst" -protoinst "protoinst_files/soc_dht11.protoinst" -protoinst "protoinst_files/bd_67cd.protoinst" -protoinst "protoinst_files/soc_btn_fnd.protoinst" -protoinst "protoinst_files/bd_57e4.protoinst" -protoinst "protoinst_files/soc_hello.protoinst" -log simulate.log
}
