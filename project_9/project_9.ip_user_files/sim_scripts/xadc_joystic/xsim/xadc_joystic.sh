...
#
# Script generated by Vivado on Mon Aug 25 15:16:44 KST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xadc_joystic.sh
...
#
# Usage        : xadc_joystic.sh
#                xadc_joystic.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_joystic.sh [-reset_run]
#                xadc_joystic.sh [-reset_log]
#                xadc_joystic.sh [-help]
#
...
# script info
echo -e "xadc_joystic.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_joystic.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_joystic xil_defaultlib.xadc_joystic xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_joystic -key {Behavioral:sim_1:Functional:xadc_joystic} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_joystic.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xadc_joystic.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xadc_joystic.sh [-help]\n\
Usage: xadc_joystic.sh [-step]\n\
Usage: xadc_joystic.sh [-lib_map_path]\n\
Usage: xadc_joystic.sh [-reset_run]\n\
Usage: xadc_joystic.sh [-reset_log]\n\
Usage: xadc_joystic.sh [-keep_index]\n\
Usage: xadc_joystic.sh [-noclean_files]\n\n\
