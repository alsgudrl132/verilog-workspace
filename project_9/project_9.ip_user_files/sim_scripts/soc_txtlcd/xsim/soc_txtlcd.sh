...
simulate()
{
  xsim soc_txtlcd -key {Behavioral:sim_1:Functional:soc_txtlcd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ee87.protoinst" -protoinst "protoinst_files/soc_dht11_iic.protoinst" -protoinst "protoinst_files/bd_5e7c.protoinst" -protoinst "protoinst_files/soc_dht11_fnd.protoinst" -protoinst "protoinst_files/soc_dht11.protoinst" -protoinst "protoinst_files/bd_67cd.protoinst" -protoinst "protoinst_files/soc_btn_fnd.protoinst" -protoinst "protoinst_files/bd_57e4.protoinst" -protoinst "protoinst_files/soc_hello.protoinst" -protoinst "protoinst_files/bd_5040.protoinst" -protoinst "protoinst_files/soc_txtlcd.protoinst" -log simulate.log
}
