...
(* CORE_GENERATION_INFO = "soc_stepper,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_stepper,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=4,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_stepper.hwdef" *) 
module soc_stepper
   (dip_switches_16bits_tri_i,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 dip_switches_16bits TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [3:0]dip_switches_16bits_tri_i;
  ...
  soc_stepper_axi_gpio_0_1 axi_gpio_0
